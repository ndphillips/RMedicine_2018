...
<font size = 5>A simple tool for creating, customizing, visualizing, and implementing fast-and-frugal trees</font>
...
---
## Creating an FFTrees object with FFTrees()
...
<h2><font color = 'gray'>print(</font>heart_FFT<font color = 'gray'>)</font></h2>
...
<br>
## Why did the tree make those decisions? What happens if you adjust its exit structure?


```{r, out.width = "50%", fig.width = 7, fig.height = 6}
plot(heart_FFT, "test")
# knitr::include_graphics("images/heart_fft_test.png")
```
...
## Those tests are very time consuming. It makes no sense to do them for every patient.
...
<font size = 5>Specify the costs of cues with cost.cues</font>
<br>
...
<br>
<font size = 5>Specify all cue costs as a named list</font>
...
<br>
## Could you try creating a tree like this?
...
<font size = 5>As long as you specify a few simple rules, the result will be a 'legit' FFTrees object</font>
...
<br><br>
## How well can an FFT compete with more complex algorithms?
...
<br3>
<font size = 5>Criterion: PredictionBalanced Accuracy</font>
<br3>
