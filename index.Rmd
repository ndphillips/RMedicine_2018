...
<br>
### What happens if you make 'minor' changes?
...
### It's much worse to miss a case than to have a false-alarm
...
FFTrees(diagnosis ~.,
        cost.cues = heart.cost,   # Include cue costs
        data = heart.train,
        data.test = heart.test,
        main = "Heart Disease")
```
...
<br><br>
### FFTs are nice for exploration. But they can't be that predictive.
